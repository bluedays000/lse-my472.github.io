...
When building such a dfm, however, we might e.g. want to avoid counts of punctuation characters. For this we make the tokenization step explicit which allows us to specify certain options, here to remove punctuation:
