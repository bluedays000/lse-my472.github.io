...
sample_text <- read_file("uol.txt")
regex_str <- "([A-Z]{1,2}[0-9]{1,2}[A-Z\\s]*)([0-9][A-Z]{1,2})"
str_view_all(sample_text, regex_str)
str_extract_all(sample_text, regex_str)
```
...
str_replace_all(sample_text, regex_str, "\\$1")
